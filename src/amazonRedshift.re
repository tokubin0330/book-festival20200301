...
1時間あたりわずか 0.25 USD で開始し、ペタバイト単位のデータと数千人の同時ユーザーに対応できるようにスケールアップできます。
ビジネスニーズにぴったり合ったものを選ぶことができ、コンピューティングを過剰にプロビジョニングすることなくストレージを増大させる能力と、ストレージのコストを増やすことなくコンピューティング性能を増強する柔軟性を備えています。
