 ...
 * AWSにサインインします。S3に移動して新しいバケットを作成して、ドメインの名前を付けます。こんかいの例はshowcase-tv.comです。
...
//list[S3_cost][S3のコスト例]{
  ...
  * 私が勤めている会社では80万PV/月のメディアをWordPressで運用していますが、4台のec2で動かしてec2のみのコストは月に約$280掛かっています。
