...
体験型のイベントで世界観も作り込まれており、始まってすぐに大人達が夢中になっていた。
5時間ほどのイベントでしたが、あっという間に終わってしまいました。
終了後には、ものすごい疲労感と参加してよかったなという満足感、
そして1位を取れなかった悔しさでいっぱいで脳汁どばどば溢れていました。
いい線いってたんです。
そして、株式会社ミクシィさんが開催している学生向け競技イベント「git challenge」もすごい。
すでに10年も続いている。
（※なお参加したことはない。サンプルが公開されているのでそちらを解いてみたりした程度）

どちらのイベントも自分がどの程度の知識を持っているのか、またどの部分について知識が足りないかを明確にしてくれて知識を整理するきっかけになる。
楽しく参加して、それでいてイベント終了後には確実に知識のレベルがアップしている。こんな素晴らしい勉強方法は他にはないかと思う。
...
「無理ですよ～。この会社のルールで、EC2に設置するキーは、担当者のキー以外設置してはいけない決まりになっているので、僕にはログインすることができません。┐(´ー｀)┌ﾔﾚﾔﾚ」
...
１問目は、Lambdaが起動しないということでした。普段気にしない項目は、思い込みにより勘違いをしてしまうものです。この設定はどういった場面で活用するかなど改めて考えいただければと思います。実はこちらの問題は、「AWS Game Day」で私が見事にハマった設定でした。悔しくて問題にしてしまいました。それから、lambdaの戻りでHTMLを返しているというところもポイントかと思います。あまり実用性はなさそうですが、HTML返せるんだぞ！
...
もし、うまく解くことができないようでしたら @ginban22 までお気軽にDMをください。
...
終わった後のみんなの表情は、疲れと安堵そして笑顔でいっぱい！参加して覚えるイベント最高です。少しづつでもこうした機会を作れたらなと思っているこの頃です。
